...
class Post extends Component {
    ...
    handleSubmit(event){
        ...
        let databody = {
            ...
            "location": this.state.loc["label"]+" "+this.state.locspec,
            "startTime": sDate,
            "endTime": eDate,
    ...
    validate(title, loc, locspec, credit) {
        ...
        if (this.state.touched.locspec && locspec.length < 1)
            errors.locspec = 'Please sepcify your location';
                            ...
                            <Col xs={12} md={{size:6, offset:3}}>
                                <FormGroup className="form-style-form-group">
                                    ...
                                    <Input  type="text" id="locspec" name="locspec" className="form-style-input" 
                                            placeholder="Please sepcify your location" value={this.state.locspec} 
