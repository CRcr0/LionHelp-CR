...
describe Api::V1::PostsController do
    ...
    describe 'POST #create' do
      ...
      # it 'create a new post fail' do
      #   post :create, params: {title: "xx"}
      #   expect(JSON.parse(response.body)["error"]).to eql('Invalid Post')
    ...
    describe 'GET #help' do
      ...
      #   expect(response).to it 'should render the index template' do
      #     get :index
      #     expect(response).to have_http_status(200)
      #   end
      # end
    ...
    #     expect { delete :destroy, id: post1.id
    #     }.to change(post, :count).by(-1)
    #   end
    #
    #   it 'redirects to posts#index after destroy' do
